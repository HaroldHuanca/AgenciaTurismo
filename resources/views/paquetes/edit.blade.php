...
@section('title', 'Editar Paquete: ' . $paquete->nombre)

@section('content')
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Editar Paquete Turístico</h1>
        <div>
            <a href="{{ route('paquetes.show', $paquete) }}" class="btn btn-info">
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Editando Paquete: {{ $paquete->nombre }}
                    </h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('paquetes.update', $paquete) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      name="descripcion" 
                                      rows="3" 
                                      placeholder="Describe los detalles del paquete, itinerario, servicios incluidos, etc.">{{ old('descripcion', $paquete->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="fecha_inicio" 
                                       name="fecha_inicio" 
                                       value="{{ old('fecha_inicio', $paquete->fecha_inicio ? \Carbon\Carbon::parse($paquete->fecha_inicio)->format('Y-m-d') : '') }}">
                                @error('fecha_inicio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('capacidad_maxima', $paquete->capacidad_maxima) }}" 
                                   min="1" 
                                   placeholder="Ej: 20">
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <a href="{{ route('paquetes.show', $paquete) }}" class="btn btn-secondary">
